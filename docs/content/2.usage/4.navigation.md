...
Nuxt Content provides a [component](/components/content-navigation) and [composable](/composables/fetch-content-navigation) to display a navigation based on the `content/` directory structure and files.
